...
function  [jointTorques]=newtonEuler( linkList, paramList, paramListDot, paramListDDot, boundary_conditions )
...
% 
% fid = fopen('a.txt', 'wt');
% fprintf(fid, '%s\n', char(jointTorques(1,1)));
% fclose(fid);
% 
% fid = fopen('b.txt', 'wt');
% fprintf(fid, '%s\n', char(jointTorques(2,1)));
% fclose(fid);
% 
% 
% fid = fopen('c.txt', 'wt');
% fprintf(fid, '%s\n', char(jointTorques(3,1)));
% fclose(fid);
% 
% 
% fid = fopen('d.txt', 'wt');
% fprintf(fid, '%s\n', char(jointTorques(4,1)));
% fclose(fid);
% 
% 
% fid = fopen('e.txt', 'wt');
% fprintf(fid, '%s\n', char(jointTorques(5,1)));
% fclose(fid);
% 
% 
% fid = fopen('f.txt', 'wt');
% fprintf(fid, '%s\n', char(jointTorques(6,1)));
% fclose(fid);
